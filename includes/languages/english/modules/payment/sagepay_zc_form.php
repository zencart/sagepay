...
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_MALFORMED_MESSAGE', 'Your card could not be recognised! Please try again, try another card or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.<p class="ExtraErrorInfo">(%s)</p>');
define('MODULE_PAYMENT_SAGEPAY_ZC_FORM_TEXT_INVALID_MESSAGE', 'Your card details could not be recognised! Please try again, try another card or <a href="index.php?main_page=contact_us">contact the administrator</a> for further assistance.<p class="ExtraErrorInfo">(%s)</p>');
...
define('TEXT_TITLE_SUHOSIN_ERROR', ' (suhosin problem)');
